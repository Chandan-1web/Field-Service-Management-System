  ...
  const handleSaveProfile = async (event) => {
    ...
    try {
      ...
      const updated = await updateMyProfile({
        ...
        // Preserve department if backend DTO contains it.
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl leading-7 text-slate-400">
              Manage your customer account information, profile picture and
              login security.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <article className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid gap-3">
              <InfoCard
                title="User ID"
                value={profile.id ? `#${profile.id}` : "Not available"}
                icon={UserRound}
              />
          ...
          <article className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              <button
                ...
                className="flex w-full items-center gap-4 rounded-2xl border border-slate-200 p-4 text-left transition hover:border-violet-200 hover:bg-violet-50"
              >
                ...
                <div>
                  <p className="font-black text-slate-900">My Requests</p>
              ...
              >
                ...
                <div>
                  <p className="font-black text-slate-900">My Sites</p>
